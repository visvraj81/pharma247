...
class CreatePurchesReturnDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purches_return_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purches_return_details');
    }
}
