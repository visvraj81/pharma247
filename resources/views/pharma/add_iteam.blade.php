                ...
                @csrf
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="suplier" placeholder="Enter Suplier">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="loaction" id="inputEmail4" placeholder="Enter Loaction">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" name="add_text_not_applicable" checked="">
                                <span class="toggle-slider round"></span>
                            </label>
                        </div>
                    </div>
