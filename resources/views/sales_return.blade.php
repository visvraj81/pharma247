    ...
    <div class="container">
      ...
      <div class="header">
        <div class="about_pharmacy">
          ...
          <div class="logo">
            <img src="{{ isset($salesDetails['logo']) ? $salesDetails['logo'] : '' }}" border="0" alt="Chemist Name" style="width: 70px; height:70px">
          </div>
          @endif
        ...
        <div class="about_invoice">
          <div class="invoice_details">
            ...
            <p class="order_datetime" style="margin-top: 3px;">
              {{ isset($salesDetails['bill_date']) ? Carbon\Carbon::parse($salesDetails['bill_date'])->format('d-m-Y') :"-"}}
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="customer-details">
        <ul>
          ...
          <li>
            <label>M :</label>{{ isset($salesDetails['customer_number']) ? $salesDetails['customer_number'] :"-"}}
          </li>
          <li>
          ...
          <!-- <li>
            <label>M</label> {{ isset($salesDetails['doctor_phone_number']) ? $salesDetails['doctor_phone_number'] :"-"}}
          </li> -->
        </ul>
      </div>
      ...
      <div class="footer">
        <div class="terms-conditions" style="height: 50px;">
          ...
          <p>
            Return/exchange within 15 days with bill. No damage/cutting.
          </p>
        </div>
        ...
        <div class="gst-bifurcation">
          <p>
            <span>Total GST</span>
            <label>
              {{isset($salesDetails['total_gst']) ? $salesDetails['total_gst'] :"₹0.0"}}
            </label>
          </p>
          <p>
            <span>Total Qty</span>
            <label>
              {{isset($salesDetails['total_qty']) ? $salesDetails['total_qty'] :"0"}}
            </label>
          </p>
          <p>
            <span>Total Item(s)</span>
            <label>
              {{isset($salesDetails['total_iteam']) ? $salesDetails['total_iteam'] :"0"}}
            </label>
          </p>
        </div>
        <div class="invoice-total-bifurcation">
          <p>
            ...
            <label>
              {{isset($salesDetails['total_base']) ? $salesDetails['total_base'] :"₹0.0"}}
            </label>
          </p>
          <p>
            <span>Round off.</span>
            <label>{{isset($salesDetails['round_off']) ? $salesDetails['round_off'] :"₹0.0"}} </label>
          </p>
          <p>
            <span>Other Amount</span>
            <label>
              {{isset($salesDetails['other_amount']) ? $salesDetails['other_amount'] :"₹0.0"}}
            </label>
          </p>
        </div>
        <div class="net-payable">
          <p class="net-amount" style="visibility: hidden;">
            ...
            <label>
              {{isset($salesDetails['net_amount']) ? $salesDetails['net_amount'] :"₹0.0"}}
            </label>
          </p>
          <p class="net-amount">
            <label>Net Amount</label>
        ...
        <!-- <div class="branding">
          <ul>
            <li style="display: flex; align-items: center;">
              <img src="{{ isset($salesDetails['logo']) ? $salesDetails['logo'] :'https://pharma247.in/public/landing_design/images/logo.png'}}"
                alt="Pharma247" title="Pharma247" class="footer-logo" />Pharma247
            </li>
          </ul>
        </div> -->
      </div>
