...
<body class="A5-print-page">
    <div class="invoice-container">
        @if(isset($purchesReturnDetails))
        @foreach($purchesReturnDetails as $list)
        <div class="container">
            <div class="header">
                <div class="about_pharmacy">
                    <div class="logo">
                        <img src="{{ isset($list['logo']) ? $list['logo'] :'https://pharma247.in/public/landing_design/images/logo.png'}}" border="0" alt="Chemist Name" style="width: 70px; height:70px" />
                    </div>
                ...
                <div class="about_invoice">
                    <div class="invoice_details">
                        ...
                        <p class="order_number order_methodname" style="margin-top: 3px;">Payment:
                            {{ isset($list['payment_type']) ? $list['payment_type'] :"-"}}
                        </p>
            ...
            <div class="customer-details">
                <ul>
                    <li>
                        <label>Distributor Name : </label>{{ isset($list['distributor_name']) ? $list['distributor_name'] :"-"}}
                    </li>
                    <li>
                        <label>M : </label>{{ isset($list['distributor_phone_number']) ? $list['distributor_phone_number'] :"-"}}
                    </li>
                </ul>
            </div>
            <div class="items-section">
                ...
                <div class="items-list" style="min-height:295px; position: relative;">
                    ...
                    <div class="invoice-bg-image">
                        <img src="{{ isset($list['logo']) ? $list['logo'] :'https://pharma247.in/public/landing_design/images/logo.png'}}" style="border-radius: 50%; height: 150px; opacity: inherit;" alt="Background Logo">
                    </div>
                    <!-- Check if item list exists -->
                    @if(isset($list['item_list']))
                    <?php $i = 1; ?>
                    @foreach($list['item_list'] as $listData)
            ...
            <div class="footer">
                <div class="gst-bifurcation" style="border-right: 1px solid black;">
                    <p>
                        <span>Total Qty</span>
                        <label>{{ isset($list['total_item_qty']) ? $list['total_item_qty'] : "0" }} + {{ isset($list['total_item_free_qty']) ? $list['total_item_free_qty'] : "0" }}</label>
                    </p>
                    <p>
                        <span>Total Item(s)</span>
                        <label>{{ isset($list['iteam_count']) ? $list['iteam_count'] : "0" }}</label>
                    </p>
                </div>
              	<div class="gst-bifurcation">
                    <p>
                        <span>Total GST</span>
                        <label>{{ isset($list['total_gst']) ? $list['total_gst'] : "0.0" }}</label>
                    </p>
                    <p>
                ...
                <div class="invoice-total-bifurcation">
                    <p>
                        ...
                        <label>{{ isset($list['total_amount']) ? $list['total_amount'] : "0.0" }}</label>
                    </p>
                    <p>
                        <span>Round off.</span>
                ...
                <div class="net-payable">
                    <p class="net-amount" style="margin-top: 5px;">
                        ...
                        <label>{{ isset($list['net_amount']) ? $list['net_amount'] : "Rs. 0.0" }}</label>
                    </p>
                </div>
            </div>
                ...
                <div class="branding">
                    <ul>
                        <li style="display: flex; align-items: center;">
                            <!-- <img src="{{ isset($list['logo']) ? $list['logo'] :'https://pharma247.in/public/landing_design/images/logo.png'}}" alt="Pharam247" title="Pharam247" class="footer-logo" />Pharma247 -->
                          	Thank You !
                        </li>
                    </ul>
                </div>
